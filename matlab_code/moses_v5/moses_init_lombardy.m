...
param.beta_exp = 0.30;    % Susceptible to exposed transition constant
param.qr  = 0;            % Daily quarantine rate (Ratio of Exposed getting Quarantined)
param.beta_inf = 0.0;     % Susceptible to infected transition constant
param.sir  = 0.06/14;     % Daily severe infected rate (Ratio of Infected getting Severe Infected)
param.eps_exp = 0.8;      % Disease transmission rate of exposed compared to the infected
...
param.gamma_mor1 = 0.3;    % Severe Infected (Hospitalized) to Dead transition probability
param.gamma_mor2 = 0.38;    % Severe Infected (Not Hospitalized) to Dead transition probability
...
param.sim_len = 140;         % Length of simulation in days
