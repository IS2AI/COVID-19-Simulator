...
param.sir  = 0.015;        % Daily severe infected rate (Ratio of Infected getting Severe Infected)
...
param.gamma_mor1 = 0.19;    % Severe Infected (Hospitalized) to Dead transition probability
param.gamma_mor2 = 0.44;     % Severe Infected (Not Hospitalized) to Dead transition probability
