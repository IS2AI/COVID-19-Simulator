...
class Network:
    def __init__(self, nodes_num, nodes_population, static_states_indices):

        self.nodes_num = nodes_num
        self.nodes_population = nodes_population
        self.static_states_indices = static_states_indices
        self.exp_thresh = 1
    ...
    def update_node_states(self, nodes, states_x_old):
        ...
        nodes_new_iter = nodes

        return nodes_new_iter


    def node_states_transition(self, nodes, transition_matrix):
            ...
            for j in range(self.nodes_num):
                ...
                if transition_matrix[i,j] > 0:
                    ...
                    for index in range(nodes[0].param_num_states):
                        ...
                        if exp_i_j[index] > 0 and index not in self.static_states_indices:
